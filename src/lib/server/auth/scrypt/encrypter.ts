// Everything in lib/scrypt comes from lucia-auth
...
const BlockMix = (input: Uint32Array, ii: number, out: Uint32Array, oi: number, r: number) => {
	let head = oi + 0;
	let tail = oi + 16 * r;
...
const scryptInit = async (password: Uint8Array, salt: Uint8Array, _opts?: ScryptOpts) => {
 ...
 */
export default async (password: Uint8Array, salt: Uint8Array, opts: ScryptOpts) => {
